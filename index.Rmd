...
```{r include = FALSE}
img7_path <- "/home/stotel/Documents/Scola/2020-2021/semester 2/blok 1/Computational Musicology/pics/plots/plottt"
img7 <- readPNG(img5_path, native = TRUE, info = TRUE)
attr(img7, "info")
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/wfWSkOiDZR4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<!--
```{r}
