...
output: 
  flexdashboard::flex_dashboard:
    ...
    theme: bootstrap
    css: stotel.css
    logo: /home/stotel/Documents/Scola/2020-2021/semester 2/blok 1/Computational Musicology/css/imgur.gif
...
***
<h2>Hi there! </h2> For this research I am going to look at film composer and music producer Ludwig Ludwig Göransson. I took data on nine of his latsest filmscores from the Spotify API, and combined all the findings in this chart. Because his database is quite big, i needed to zoom in to only certain playlists and variables. I was curious beforehand if i could find some significant relations between different variables, to build my story on. As you can see the variable accousticness has twee negative (significant) relationships. In my next pages i'm going to try to see what these changes mean and if i can show them in different ways. 
...
***
<h3> Accousticness? </h3> So what actually is accousticness? It's not that difficult, and quite self-explanatory. It means how accoustic a track is. 
...
```{r include = FALSE}
col = c(KRD012="#330033" , KRD022="#330033" , KRD026="#330033",
             KRD070="#330033" , KRD077="#330033" , KRD096="#330033", 
             KRD128="#330033" , KRD153="#330033", KRD140="#FF3300", 
             KRD162="#3399CC" , KRD175="#3399CC" , KRD197="#3399CC", 
             KRD172="#FFCC00" , KRD174="#FFCC00" , KRD171="#006600",  
             KRD186="#00CCFF" , KRD202="#99CC00" ,  NRPS= "grey", NRPS.like= "grey", Type.1.PKS= "grey", Type.2.PKS= "grey",Type.3.PKS= "grey",
             hglE.KS= "grey", Terpene= "grey", Betalactone= "grey",
             Siderophore= "grey", Butyrolactone= "grey", 
             Arylpolyene= "grey", Ectoine= "grey", LAP= "grey", 
             Lassopeptide= "grey", Bacteriocin= "grey", 
             Hybrid= "grey")
...
c <- chordDiagram(data, grid.col = col, annotationTrack = "grid", preAllocateTracks = 1, scale = FALSE)
...
dev.copy(jpeg,'plot.png', width=8, height=8, units="in", res=3500)
dev.off()
...
<html>
<iframe src="https://open.spotify.com/embed/track/7640a8QzLN6txA7Fa2q8oo" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe></html>
